...
# ✅ الأمر النهائي الصحيح: قبول الشروط أولاً، ثم التسجيل، ثم الاتصال
CMD warp-svc --accept-tos & sleep 3 && warp-cli accept-tos && warp-cli registration new && sleep 2 && warp-cli connect && python app.py