...
# ✅ الأمر النهائي الصحيح: --accept-tos قبل registration new
CMD warp-svc --accept-tos & sleep 3 && warp-cli --accept-tos registration new && sleep 2 && warp-cli connect && python app.py