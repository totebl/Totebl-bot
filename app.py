                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ------------------------------------------------------------
                            # 13. أوامر فلتر النموذج الأول والثاني والثالث (مرتبة: الثالث، الثاني، الأول)
                            # ------------------------------------------------------------
                            # فلتر النموذج الثالث (يُفحص أولاً)
                            ...
                            # فلتر النموذج الثاني (يُفحص ثانياً)
                            ...
                            # فلتر النموذج الأول (يُفحص أخيراً - مع كلمة "الأول")
                            ...
                            # ------------------------------------------------------------
                                ...
                                send_telegram("🟢 تم إعادة ضبط جميع الفلاتر والإعدادات الديناميكية إلى القيم الافتراضية (مع فلاتر النماذج الأول والثاني والثالث).")
                                save_state()
...
def load_state():
    ...
    global SINGLE_MODEL_FILTER_MODEL, SINGLE_MODEL_FILTER_THRESHOLD, SINGLE_MODEL_FILTER_TIMEFRAME, SINGLE_MODEL_FILTER_ENABLED
    global SECOND_MODEL_FILTER_MODEL, SECOND_MODEL_FILTER_THRESHOLD, SECOND_MODEL_FILTER_TIMEFRAME, SECOND_MODEL_FILTER_ENABLED
    global THIRD_MODEL_FILTER_MODEL, THIRD_MODEL_FILTER_THRESHOLD, THIRD_MODEL_FILTER_TIMEFRAME, THIRD_MODEL_FILTER_ENABLED  # <-- أضف هذا
    # === التحديث 3: متغيرات البيع ===
    global SELL_PARTIAL_THRESHOLD, SELL_FULL_THRESHOLD, SELL_MEMBER_WEIGHTS, SELL_FRAME_WEIGHTS
    # === الحد الأعلى الموحد ===
