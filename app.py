# ========================================================================
# بوت التداول v27.8 – إصدار مستقر معدل لـ Binance Spot
# التغييرات فقط: استبدال stop_market بـ stop_loss في أوامر الوقف المسبق
                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ------------------------------------------------------------
                            # 11. أمر إعادة ضبط الفلاتر (معدل ليشمل الإعدادات الديناميكية)
                            # ------------------------------------------------------------
                                ...
                                CUSTOM_MAX_EXPOSED_PERCENT = MAX_EXPOSED_PERCENT
                                CUSTOM_POSITION_PERCENT_GOOD = MAX_POSITION_PERCENT_GOOD
                                CUSTOM_POSITION_PERCENT_NORMAL = 0.25   # يمكن تغييرها إلى 0.15 إذا أردت
                            ...
                            # ------------------------------------------------------------
                            # 12. أمر رسم منحنى الرصيد الكلي (جديد)
                            # ------------------------------------------------------------
