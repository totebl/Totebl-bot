...
# - إعادة محاولة جلب الشموع كل 10 ثوانٍ لمدة 50 ثانية كحد أقصى (بدلاً من 5 دقائق)
# - تعديل لجنة الشراء: تخفيض العتبات بنسبة 25% (min_conf, thresh1,2,3)
# ========================================================================
...
STRENGTH_THRESHOLD = float(os.environ.get('STRENGTH_THRESHOLD', 0.25))  # لم يتغير
SCALP_MIN_PROFIT = float(os.environ.get('SCALP_MIN_PROFIT', 0.20))      # لم يتغير
...
class BuyingCommittee:
    ...
    def decide(self, df_primary, symbol, sym_type='normal', market_condition='normal'):
        ...
        # ========== العتبات الجديدة بعد تخفيض 25% ==========
        if sym_type == 'meme':
            config = {
                'bad': {'min_conf': 0.35, 'thresh3': 0.40, 'thresh2': 0.36, 'thresh1': 0.35,
                        'weak_penalty_15m': 0.06, 'strong_bonus_15m': 0.15,
                        'weak_penalty_1h': 0.06, 'strong_bonus_1h': 0.15},
                'normal': {'min_conf': 0.32, 'thresh3': 0.36, 'thresh2': 0.32, 'thresh1': 0.32,
                           'weak_penalty_15m': 0.05, 'strong_bonus_15m': 0.18,
                           'weak_penalty_1h': 0.05, 'strong_bonus_1h': 0.18},
                'good': {'min_conf': 0.30, 'thresh3': 0.34, 'thresh2': 0.30, 'thresh1': 0.30,
                         'weak_penalty_15m': 0.04, 'strong_bonus_15m': 0.20,
                         'weak_penalty_1h': 0.04, 'strong_bonus_1h': 0.20}
            }
        else:  # normal
            config = {
                'bad': {'min_conf': 0.38, 'thresh3': 0.44, 'thresh2': 0.40, 'thresh1': 0.38,
                        'weak_penalty_15m': 0.08, 'strong_bonus_15m': 0.12,
                        'weak_penalty_1h': 0.08, 'strong_bonus_1h': 0.12},
                'normal': {'min_conf': 0.34, 'thresh3': 0.40, 'thresh2': 0.36, 'thresh1': 0.34,
                           'weak_penalty_15m': 0.07, 'strong_bonus_15m': 0.15,
                           'weak_penalty_1h': 0.07, 'strong_bonus_1h': 0.15},
                'good': {'min_conf': 0.32, 'thresh3': 0.38, 'thresh2': 0.34, 'thresh1': 0.32,
                         'weak_penalty_15m': 0.05, 'strong_bonus_15m': 0.18,
                         'weak_penalty_1h': 0.05, 'strong_bonus_1h': 0.18}
            }
        # ================================================
