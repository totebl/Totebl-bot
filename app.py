# ========================================================================
# بوت التداول v27.8 – إصدار مستقر معدل لـ Binance Spot + DeepSeek Filter
# التغييرات فقط: إضافة فلتر DeepSeek النهائي مع تحكم عبر تلغرام
...
التغير خلال 24 ساعة: {change_24h:.2f}% إذا كان متوفراً
حجم التداول 24 ساعة (USDT): {volume_24h_usd:,.0f} إذا كان متوفراً

المؤشرات الفنية (آخر شمعة):
- RSI (14): {last_rsi:.2f}
- MACD: {last_macd_diff:.6f} (فرق) والإشارة: {last_macd_signal:.6f}
- نسبة الحجم إلى المتوسط: {last_volume_ratio:.2f}
- EMA 9: {last_ema_9:.8f} | EMA 21: {last_ema_21:.8f} | تقاطع صاعد: {'نعم' if ema_cross_bullish else 'لا'}
- البولينجر باند: علوي {last_bb_upper:.8f} | سفلي {last_bb_lower:.8f} | العرض: {last_bb_width:.3f}
- ATR%: {last_atr_percent:.4f}
- ADX: {last_adx:.1f}
- الزخم لآخر 5 شموع: {momentum_5:.4f}
