                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ------------------------------------------------------------
                            # 6. أوامر ضبط فترة التبريد ومدة المسح ووقت الانتظار
                            # ------------------------------------------------------------
                            ...
                            # ------------------------------------------------------------
                            # 14. أوامر إيقاف دخول الصفقات الجديدة
                            # ------------------------------------------------------------
