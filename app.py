# ========================================================================
# بوت التداول v27.6 – إصدار نهائي (مع تسريع مراقبة المراكز إلى 0.5 ثانية)
# ========================================================================
...
def monitor_positions():
    ...
    while True:
        try:
            ...
            if not all_tickers: time.sleep(0.5); continue
            with _market_condition_lock:
            ...
            for sym, pos in snapshot:
                ...
                if profit <= -0.06:
                    ...
                    continue
            time.sleep(0.5)   # تم التعديل من 3 ثوانٍ إلى 0.5 ثانية لتحسين الاستجابة
        except Exception as e:
