                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ------------------------------------------------------------
                            # 6. أوامر ضبط مدة المسح ووقت الانتظار (تم حذف "فلتر التبريد" القديم)
                            # ------------------------------------------------------------
                            ...
                            # ------------------------------------------------------------
                            # 13. أمر إعادة ضبط الفلاتر (تم تحديثه ليشمل قيم التبريد الجديدة)
                            # ------------------------------------------------------------
                                ...
                                with _30d_cache_lock:
                                    _30d_performance_cache.clear()
                                send_telegram("🟢 تم إعادة ضبط جميع الفلاتر والإعدادات الديناميكية إلى القيم الافتراضية الأصلية (الذكاء الاصطناعي معطل، النموذج الافتراضي Flash، نظام التبريد الذكي مفعّل بـ 12 ساعة للرابح و 5 دقائق للخاسر)")
                                save_state()
