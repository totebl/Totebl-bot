...
# --------------------------- دالة telegram_polling المعدلة (بإضافة جميع الأوامر المفقودة + أمر منحنى) ---------------------------
                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ------------------------------------------------------------
                            # 10. أمر إعادة ضبط الفلاتر (معدل ليشمل الإعدادات الديناميكية)
                            # ------------------------------------------------------------
                            ...
                            # ------------------------------------------------------------
                            # 11. أمر رسم منحنى الرصيد الكلي (جديد)
                            # ------------------------------------------------------------
