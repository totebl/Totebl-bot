...
# مبني على الكود الأصلي v27.8 مع إضافة كافة أوامر v27.7
# والحفاظ على جميع التحسينات الجديدة (المتغيرات الديناميكية، tp_hit_count، تحسين get_total_equity،
# منع البيع الجزئي الصغير، وأوامر تلغرام الجديدة: عدد رموز التحليل، حجم التعرض، حجم صفقة السوق...)
# ========================================================================
...
def place_preemptive_stop_loss(symbol, size, entry_price, sym_type, stop_price_override=None):
    ...
    if stop_price_override is not None:
        ...
        trigger = PREPLACED_SL_TRIGGER_PERCENT
        limit_pct = PREPLACED_SL_LIMIT_PERCENT
