...
# مبني على الأصل v27.8 مع إضافة كافة أوامر v27.7 (الفلاتر، التبديل، عتبات الشراء، التبريد، المسح)
...
# --------------------------- دالة telegram_polling المعدلة (بإضافة جميع الأوامر المفقودة) ---------------------------
...
if __name__ == '__main__':
    ...
    logger.info(f"🚀 بدء البوت v27.8 (النهائي المستقر بعد إضافة الأوامر المفقودة) - الوضع: {mode_str}")
