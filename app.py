...
def analyze_and_trade():
    ...
    try:
        ...
        for sym in active:
            ...
            # 🆕 التحديث 3: حذف الفحص المكرر للتعرض (curr_exp) - الاعتماد على exp المحدَّث فقط
        ...
        # ============================================================
        # 🆕 إشعار إغلاق دورة التحليل (يشمل الحالتين: طبيعي / تايم آوت)
        # ============================================================
        if analyzed_count > 0:
            cycle_duration = time.time() - cycle_start_time
            timed_out = cycle_duration >= MAX_ANALYSIS_CYCLE_SECONDS
