...
SELL_FRAME_WEIGHTS = {'5m': 0.30, '15m': 0.10, '1h': 0.60}
# ======================================================================
...
SELL_15M_CHECK_INTERVAL = 60  # كل 60 ثانية
...
def load_state():
    ...
    try:
        ...
        SELL_MEMBER_WEIGHTS = filters.get('sell_member_weights', {'rule':0.0, 'emr':0.0, 'cfhm':0.0, 'timing':0.0, 'vwap_obv':0.0})
        SELL_FRAME_WEIGHTS = filters.get('sell_frame_weights', {'5m':0.0, '15m':0.0, '1h':0.0})
