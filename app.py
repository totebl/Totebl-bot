...
TAKE_PROFIT_LEVELS_MEME = [0.015, 0.020, 0.025, 0.035, 0.045, 0.055, 0.070]
...
def analyze_and_trade():
    ...
    try:
        ...
        # ============================================================
        # 🆕 إشعار إغلاق دورة التحليل (مع عدّادات تفصيلية - التحديث السادس + السابع)
        # ============================================================
        if analyzed_count > 0:
