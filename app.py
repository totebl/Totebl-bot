...
#   - رفع الحد الأقصى للتعرض الكلي (MAX_EXPOSED_PERCENT) من 65% إلى 70%.
#   - إضافة تفصيل حجم الصفقة حسب حالة السوق: جيد (25%)، عادي (20%)، سيء (15%).
# ========================================================================
...
MAX_POSITION_PERCENT_GOOD = float(os.environ.get('MAX_POSITION_PERCENT_GOOD', 0.25))   # تم الرفع إلى 25%
MAX_POSITION_PERCENT_NORMAL = float(os.environ.get('MAX_POSITION_PERCENT_NORMAL', 0.20))  # جديد: 20% للسوق العادي
MAX_POSITION_PERCENT_BAD = float(os.environ.get('MAX_POSITION_PERCENT_BAD', 0.15))       # جديد: 15% للسوق السيء
...
MAX_EXPOSED_PERCENT = float(os.environ.get('MAX_EXPOSED_PERCENT', 0.70))   # تم الرفع من 0.65 إلى 0.70
