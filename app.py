...
STRENGTH_THRESHOLD = float(os.environ.get('STRENGTH_THRESHOLD', 0.30))
SCALP_MIN_PROFIT = float(os.environ.get('SCALP_MIN_PROFIT', 0.25))
    ...
    while True:
        try:
            ...
            for sym, pos in snapshot:
                ...
                # باقي آليات المراقبة الأخرى (انهيار مفاجئ، لجنة البيع، التريلينغ، أهداف الربح، إلخ)
                # نتركها كما هي دون تغيير.

                # ملاحظة: تم إزالة القسم القديم الذي كان يعتمد على الزخم (profit < 0 مع mom_ratio)
