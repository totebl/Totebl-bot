# ========================================================================
# بوت التداول المتطور v26.4 - تحكم كامل عن طريق تلغرام + رصيد حقيقي
# - تحسينات الذاكرة ومنع التسريب (deque, تنظيف error reports, مكنسة محسنة)
# - إصلاح ترتيب الدوال لتجنب NameError المبكر
# - دعم أفضل لمنصة Render (PORT, use_reloader=False, تسجيل واضح)
# - إضافة try/except حول تشغيل Flask لالتقاط الأخطاء
...
<head><meta charset="UTF-8"><title>بوت v26.4</title></head>
<body style="background:#0a0e27;color:#e0e0e0;font-family:sans-serif;padding:20px;">
<h1>🤖 بوت التداول v26.4 – تحكم كامل + تحسينات الذاكرة + دعم أفضل للمنصات السحابية</h1>
<div id="stats"></div>
...
@csrf.exempt
def ping():
    return jsonify({"status":"pong","version":"26.4"})
...
@app.route('/')
def home():
    return jsonify({"status":"بوت v26.4 – تحكم كامل + تحسينات الذاكرة + دعم أفضل للمنصات السحابية", "version":"26.4"})
...
@csrf.exempt
def health():
    return jsonify({"healthy":True,"paused":_is_paused(),"open":len(open_positions),"version":"26.4"})
