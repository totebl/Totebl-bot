...
MIN_VOLUME_USD = float(os.environ.get('MIN_VOLUME_USD', 2000000))
...
MIN_24H_VOLUME_USD = float(os.environ.get('MIN_24H_VOLUME_USD', 2000_000))
...
def detect_market_regime(symbol):
    df = fetch_ohlcv_retry(symbol, '15m', limit=200)
    if df.empty:
        return 'neutral'
    df_f = get_cached_features(symbol, '15m', limit=200, ttl=120)
    if df_f.empty:
        return 'neutral'
...
def analyze_and_trade():
    ...
    try:
        ...
        # ============================================================
        # 🆕 إشعار إغلاق دورة التحليل (مع عدّادات تفصيلية - التحديث السادس)
        # ============================================================
        if analyzed_count > 0:
                    ...
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ========== أمر إعادة الضبط ==========
                                ...
                                UPPER_WICK_FILTER_ENABLED = True
                                MAX_UPPER_WICK_DISTANCE_PERCENT = 0.0166   # 🆕 1.66% بدل 0.0044
