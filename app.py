...
LOCK_TIMEOUT_SECONDS = 660   # تم التعديل من 480 إلى 660 (11 دقيقة)
_manipulation_cache = {}
...
def monitor_positions():
    ...
    while True:
        try:
            ...
            if not all_tickers: time.sleep(1.5); continue   # تم التعديل إلى 1.5 ثانية
            with _market_condition_lock:
            ...
            for sym, pos in snapshot:
                ...
                if profit <= -0.06:
                    ...
                    continue
            time.sleep(1.5)   # تم التعديل من 0.5 إلى 1.5 ثانية
        except Exception as e:
...
# --------------------------- دالة التحليل الرئيسية (بدون تغيير) ---------------------------
