# ========================================================================
# بوت التداول المتطور v27.3 - إصلاح استيراد as_completed
# - إضافة as_completed إلى الاستيراد من concurrent.futures
# - جميع التحسينات السابقة: مراقبة الخيوط، تحرير القفل، مهلة جلب الرصيد
# - تثبيت تلقائي لـ waitress
# ========================================================================
...
<head><meta charset="UTF-8"><title>بوت v27.3</title></head>
<body style="background:#0a0e27;color:#e0e0e0;font-family:sans-serif;padding:20px;">
<h1>🤖 بوت التداول v27.3 – إصلاح استيراد as_completed</h1>
<div id="stats"></div>
...
@csrf.exempt
def ping():
    return jsonify({"status":"pong","version":"27.3"})
...
@app.route('/')
def home():
    return jsonify({"status":"بوت v27.3 – إصلاح استيراد as_completed وتحسينات الاستقرار", "version":"27.3"})
...
@csrf.exempt
def health():
    return jsonify({"healthy":True,"paused":_is_paused(),"open":len(open_positions),"version":"27.3"})
