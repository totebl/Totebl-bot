...
MAX_POSITION_PERCENT_GOOD = float(os.environ.get('MAX_POSITION_PERCENT_GOOD', 0.20))   # تم التعديل: 20% (كانت 25%)
MAX_POSITION_PERCENT_NORMAL = float(os.environ.get('MAX_POSITION_PERCENT_NORMAL', 0.20))  # 20% للسوق العادي
MAX_POSITION_PERCENT_BAD = float(os.environ.get('MAX_POSITION_PERCENT_BAD', 0.15))       # 15% للسوق السيء
