# ========================================================================
# بوت التداول v27.8 – إصدار مستقر مع إصلاحات شاملة
# مبني على الأصل v27.7 مع إضافة جميع التحسينات المطلوبة
# ✅ التحسينات المضافة:
#    - متغيرات ديناميكية للتحكم بعدد الرموز وحجم التعرض وحجم الصفقة حسب حالة السوق
#    - tp_hit_count لترقيم أهداف الربح
#    - تحسين get_total_equity (WebSocket ثم API مع إعادة محاولات)
#    - منع البيع الجزئي الصغير جداً (أقل من min_cost)
#    - أوامر تلغرام جديدة: عدد رموز التحليل, حجم التعرض, حجم صفقة السوق...
#    - تحديث analyze_and_trade لاستخدام المتغيرات الديناميكية وحساب total_eq2 مرة واحدة
#    - تحديث save_state/load_state لحفظ custom_settings و tp_hit_count
#    - إضافة try-except لـ get_amount_limits في close_partial
# ========================================================================
                    ...
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            if text.startswith('تعيين عتبة خسارة 25%'):
                                ...
                                STOP_LOSS_PARTIAL_2_PERCENT = 0.012
                                STOP_LOSS_FULL_PERCENT = 0.017
                                # إعادة ضبط الإعدادات الديناميكية
                                CUSTOM_ACTIVE_SYMBOLS_LIMIT = ACTIVE_SYMBOLS_LIMIT
                                CUSTOM_MAX_EXPOSED_PERCENT = MAX_EXPOSED_PERCENT
                                CUSTOM_POSITION_PERCENT_GOOD = MAX_POSITION_PERCENT_GOOD
...
if __name__ == '__main__':
    ...
    logger.info(f"🚀 بدء البوت v27.8 (النهائي المستقر) - الوضع: {mode_str}")
