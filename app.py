# ========================================================================
# بوت التداول المتطور v26.0 - تحكم كامل عن طريق تلغرام + رصيد حقيقي
...
<head><meta charset="UTF-8"><title>بوت v26.0</title></head>
<body style="background:#0a0e27;color:#e0e0e0;font-family:sans-serif;padding:20px;">
<h1>🤖 بوت التداول v26.0 – تحكم كامل + رصيد فوري</h1>
<div id="stats"></div>
...
@csrf.exempt
def ping():
    return jsonify({"status":"pong","version":"26.0"})
...
@app.route('/')
def home():
    return jsonify({"status":"بوت v26.0 – تحكم كامل عبر تلغرام + رصيد فوري", "version":"26.0"})
...
@csrf.exempt
def health():
    return jsonify({"healthy":True,"paused":_is_paused(),"open":len(open_positions),"version":"26.0"})
