...
def auto_recovery_monitor():
    ...
    while True:
        ...
        try:
            ...
            if ticker and ticker.get('last') is not None:
                ...
                with _AUTO_RECOVERY_LOCK:
                    _auto_recovery_failures = 0
                # 🔴 نوم عشوائي بين 60 و 300 ثانية (1-5 دقائق)
        ...
        if recovery_attempts_remaining > 0:
            time.sleep(random.uniform(10, 30))  # نوم عشوائي بين المحاولات
            ...
            if recovery_attempts_remaining == 0:
                ...
                try:
                    ...
                    recovery_attempts_remaining = 0
                    time.sleep(random.uniform(120, 300))  # نوم عشوائي قبل إعادة المحاولة
            continue
        else:
            time.sleep(random.uniform(60, 300))
...
def analyze_and_trade():
    ...
    # ========== التعديل رقم 1: إيقاف التحليل بالكامل إذا كان عدد الرموز = 0 ==========
    if CUSTOM_ACTIVE_SYMBOLS_LIMIT <= 0:
        logger.info("⏸️ عدد رموز التحليل = 0، تخطي التحليل (لا تُرسل أي طلبات REST).")
        return
...
# ========== التعديل رقم 3: مزامنة الأوامر المعلقة كل 3 ساعات ==========
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ========== أوامر ضبط مدة المسح ووقت الانتظار ==========
                                ...
                                if match:
                                    ...
                                    # ========== التعديل رقم 2: السماح بما يصل إلى 1440 دقيقة ==========
