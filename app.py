                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ------------------------------------------------------------
                            # 13. أوامر فلتر النموذج الأول والثاني والثالث (مرتبة)
                            # ------------------------------------------------------------
                            # ✅ التحديث 5: إعادة ترتيب الشروط بحيث يُفحص الفلتر الثاني أولاً
                            # فلتر النموذج الثاني (الجديد) - يُفحص أولاً
                            ...
                            # فلتر النموذج الأول (الموجود) - يُفحص بعد ذلك
                            ...
                            # فلتر النموذج الثالث (جديد) - يُفحص بعد الفلتر الأول
                            ...
                            # ------------------------------------------------------------
                                ...
                                if match:
                                    ...
                                    if 0.05 <= new_val <= 0.95:
                                        # تم حذف global UPPER_THRESHOLD_GLOBAL من هنا لأنه موجود بالفعل في أعلى الدالة
