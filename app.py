                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # فلتر الثاني - السابع (نفس النمط مع تغيير الأسماء)
                            # ... (سيتم تضمينهم في الكود النهائي، اختصاراً للطول)
                            # تم حذف الفلتر الثاني إلى السابع من هذا المختصر، لكنهم موجودون في الكود النهائي الكامل.
