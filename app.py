...
class EMRModel:
    ...
    def update(self, symbol, df):
        ...
        # حل مشكلة البداية الباردة: إذا كان عدد الطورات أقل من 3، نعيد درجة محايدة
        if symbol not in self.symbol_phases or len(self.symbol_phases[symbol]) < 3:
...
# --------------------------- لجنة الشراء (محسّنة مع العضو الرابع) ---------------------------
class BuyingCommittee:
    ...
    def decide(self, df_primary, symbol, sym_type='normal', market_condition='normal'):
        ...
        # جلب البيانات التأكيدية مع تغيير نموذج التأكيد من rule إلى emr
        ...
        # تأكيد باستخدام نموذج EMR (وليس rule) للإطار 5 دقائق
        ...
        # تأكيد باستخدام نموذج EMR للإطار 1 ساعة
