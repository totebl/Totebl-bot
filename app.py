...
SINGLE_MODEL_FILTER_MODEL = os.environ.get('SINGLE_MODEL_FILTER_MODEL', 'emr')          # ✅ emr
SINGLE_MODEL_FILTER_THRESHOLD = float(os.environ.get('SINGLE_MODEL_FILTER_THRESHOLD', 0.35))  # ✅ 0.35
SINGLE_MODEL_FILTER_TIMEFRAME = os.environ.get('SINGLE_MODEL_FILTER_TIMEFRAME', '1h')     # ✅ 1h
...
SELL_15M_CHECK_INTERVAL = 108  # كل 108 ثانية
...
def background_analyzer():
    ...
    while True:
        if PAUSE_ANALYSIS:
            ...
            continue
        analyze_and_trade()
        time.sleep(180)   # تم التعديل من 100 إلى 180 ثانية (3 دقائق)
...
def telegram_polling():
    ...
    # تم حذف SELL_15M_THRESHOLD من global لأنه غير مستخدم
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ======================== تم تحديث أمر حالة الفلاتر لعرض أوزان النماذج وعتبات البيع ========================
                                ...
                                status = (f"📊 <b>حالة الفلاتر والقيم الحالية</b>\n━━━━━━━━━━━━━━━━━━━━\n"
                                          ...
                                          f"🎯 <b>عتبة شراء عادي:</b> {STRENGTH_THRESHOLD:.2f}\n"
                                          f"🎯 <b>عتبة شراء ميم:</b> {SCALP_MIN_PROFIT:.2f}\n"
