...
def analyze_and_trade():
    ...
    try:
        ...
        all_syms = list(set(scanner.candidates + list(open_positions.keys())))
                ...
                if data.get("ok"):
                    for upd in data.get("result",[]):
                        ...
                        if msg and str(msg["chat"]["id"]) == str(TELEGRAM_CHAT_ID):
                            ...
                            # ------------------------------------------------------------
                            # 13. أوامر فلتر النموذج الأول والثاني
                            # ------------------------------------------------------------
                            ...
                            # ------------------------------------------------------------
                                ...
                                send_telegram("🟢 تم إعادة ضبط جميع الفلاتر والإعدادات الديناميكية إلى القيم الافتراضية (مع فلتر النموذج الأول: Rule/5m/0.11 والثاني: CFHM/5m/0.59)")
                                save_state()
