...
if __name__ == '__main__':
    ...
    send_telegram(f"🚀 بوت v29.0 (النسخة المبسطة بعد التنظيف + التحديثات) يعمل – الوضع: {mode_str}\n"
                  ...
                  f"   6) 📋 إشعار ختامي مع عدّادات تفصيلية لأسباب الرفض (اتجاه/بيانات/لجنة/عتبة/سعر/شمعة/حجم/رصيد/سيولة)\n"
                  f"   7) 🔥 فلتر جسم الشمعة: حد {MAX_CANDLE_BODY_PERCENT:.2%} (يرفض الشموع الصاعدة بقوة)\n"
