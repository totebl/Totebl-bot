# ========================================================================
# بوت التداول المتطور v26.2 - تحكم كامل عن طريق تلغرام + رصيد حقيقي
# - تحسينات الذاكرة ومنع التسريب
# - استخدام deque للـ equity_curve
# - تنظيف تلقائي لـ _last_error_report_times
# - تحسين cache_cleanup_thread
# - إضافة memory_watchdog احتياطي
# ========================================================================
...
<head><meta charset="UTF-8"><title>بوت v26.2</title></head>
<body style="background:#0a0e27;color:#e0e0e0;font-family:sans-serif;padding:20px;">
<h1>🤖 بوت التداول v26.2 – تحكم كامل + تحسينات الذاكرة</h1>
<div id="stats"></div>
...
@csrf.exempt
def ping():
    return jsonify({"status":"pong","version":"26.2"})
...
@app.route('/')
def home():
    return jsonify({"status":"بوت v26.2 – تحكم كامل + تحسينات الذاكرة", "version":"26.2"})
...
@csrf.exempt
def health():
    return jsonify({"healthy":True,"paused":_is_paused(),"open":len(open_positions),"version":"26.2"})
