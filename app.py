# ========================================================================
# بوت التداول المتطور v27.1 - تحكم كامل عن طريق تلغرام + رصيد حقيقي
# - تحسينات استقرار الخيوط: مراقب خيط تلغرام وإعادة تشغيله تلقائياً
# - مراقبة القفل المعلق وتحريره بعد 5 دقائق لمنع تجمد التحليل
# - تقليل مهلة تلغرام إلى 15 ثانية لتفادي الانتظار الطويل
# - تثبيت تلقائي لخادم Waitress (مع الاحتفاظ بـ Flask كبديل)
# - تحسينات الذاكرة ومنع التسريب
# ========================================================================
...
<head><meta charset="UTF-8"><title>بوت v27.1</title></head>
<body style="background:#0a0e27;color:#e0e0e0;font-family:sans-serif;padding:20px;">
<h1>🤖 بوت التداول v27.1 – استقرار عالي + مراقبة الخيوط</h1>
<div id="stats"></div>
...
@csrf.exempt
def ping():
    return jsonify({"status":"pong","version":"27.1"})
...
@app.route('/')
def home():
    return jsonify({"status":"بوت v27.1 – استقرار عالي + تثبيت تلقائي لـ Waitress", "version":"27.1"})
...
@csrf.exempt
def health():
    return jsonify({"healthy":True,"paused":_is_paused(),"open":len(open_positions),"version":"27.1"})
